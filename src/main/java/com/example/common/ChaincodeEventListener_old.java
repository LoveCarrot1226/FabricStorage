...
@Slf4j
public class ChaincodeEventListener_old implements Runnable {

    final Network network;

    public ChaincodeEventListener_old(Network network) {
    ...
    @Override
    public void run() {
        CloseableIterator<ChaincodeEvent> events = network.getChaincodeEvents("datasharing-contract-java-1");
