...
import com.example.DizkZKP.algebra.curves.barreto_naehrig.BNPublicParameters;
...
import com.example.DizkZKP.algebra.curves.barreto_naehrig.bn254a.bn254a_parameters.BN254aFq2Parameters;
...
public class BN254aPublicParameters
    ...
    public BN254aPublicParameters() {
        ...
        finalExponent = new BigInteger("");
