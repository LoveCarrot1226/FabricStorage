...
public class BN254bG1Parameters
    ...
    public static final BN254bG1 ONE = new BN254bG1(new BN254bFq("6"), new BN254bFq("8804219299324514492806343261084073560212908759422749787101710634723026910978"), BN254bFq.ONE);
