...
package com.example.DizkZKP.algebra.fields;
...
public class Fp2 extends AbstractFieldElement<Fp2> implements Serializable {
    ...
    /* Devegili OhEig Scott Dahab --- Multiplication and Squaring on AbstractPairing-Friendly
     Fields.pdf; Section 3 (Complex squaring) */
        ...
        return new Fp2(
                factor.sub(c0c1).sub(Fp2Parameters.nonresidue().mul(c0c1)),
                c0c1.add(c0c1),
                Fp2Parameters);
    }
    ...
    public Fp2 FrobeniusMap(long power) {
        return new Fp2(
                c0,
                Fp2Parameters.FrobeniusMapCoefficientsC1()[(int) power % 2].mul(c1),
                Fp2Parameters);
    }
