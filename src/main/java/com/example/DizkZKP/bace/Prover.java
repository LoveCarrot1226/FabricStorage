...
package com.example.DizkZKP.bace;
...
import com.example.DizkZKP.bace.circuit.Circuit;
import com.example.DizkZKP.common.Combiner;
...
public class Prover<FieldT extends AbstractFieldElementExpanded<FieldT>> {
    ...
    public Tuple2<Long, JavaPairRDD<Long, FieldT>> computeProof(
            ...
            final int numPartitions) throws Exception {
        ...
        final JavaPairRDD<Long, FieldT> evaluatedPolynomials = transposedPolynomials
                .mapValues(column -> {
