...
package com.example.DizkZKP.relations.r1cs;
...
import com.example.DizkZKP.relations.objects.R1CSConstraint;
import com.example.DizkZKP.relations.objects.R1CSConstraints;
 ...
 */
public class R1CSRelation<FieldT extends AbstractFieldElementExpanded<FieldT>> implements
        Serializable {
    ...
    public R1CSRelation(
            final R1CSConstraints<FieldT> _constraints,
            final int _numInputs,
            final int _numAuxiliary) {
