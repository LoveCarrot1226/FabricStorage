...
package com.example.DizkZKP.relations.objects;
 ...
 * <p>
 * A R1CSRelation constraint is used to construct a R1CSRelation constraint system.
 */
public class R1CSConstraint<FieldT extends AbstractFieldElementExpanded<FieldT>> implements
        Serializable {
    ...
    public R1CSConstraint(
            LinearCombination<FieldT> _A,
            LinearCombination<FieldT> _B,
            LinearCombination<FieldT> _C) {
        A = _A;
        B = _B;
        C = _C;
    }
