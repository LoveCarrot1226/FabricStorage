...
public class FpArithmeticProfiling {
    ...
    public static void BN128FrArithmeticProfiling(final Configuration config, final int size) {
        ...
        System.out.println("Addition: " + totalNanoAddition + " ns / " + size + " = " + ((double) totalNanoAddition / size) + " ns");
        ...
        System.out.println("Multiplication: " + totalNanoMultiplication + " ns / " + size + " = " + ((double) totalNanoMultiplication / size) + " ns");
