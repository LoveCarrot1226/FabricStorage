...
import com.example.DizkZKP.reductions.r1cs_to_qap.R1CStoQAPRDD;
import com.example.DizkZKP.relations.objects.Assignment;
import com.example.DizkZKP.relations.qap.QAPWitness;
import com.example.DizkZKP.relations.qap.QAPWitnessRDD;
...
public class R1CStoQAPWitnessProfiling {
    ...
    public static void serialQAPWitness(final Configuration config, final long numConstraints) {
        ...
        final Tuple3<R1CSRelation<BN254aFr>, Assignment<BN254aFr>, Assignment<BN254aFr>> R1CSExample =
                R1CSConstruction
                        .serialConstruct((int) numConstraints, numInputs, fieldFactory, config);
    ...
    public static void distributedQAPWitness(final Configuration config, final long numConstraints) {
        ...
        config.beginRuntime("Witness");
        final QAPWitnessRDD<BN254aFr> qapWitnessRDD = R1CStoQAPRDD
                .R1CStoQAPWitness(r1csRDD, primary, fullAssignmentRDD, fieldFactory, config);
